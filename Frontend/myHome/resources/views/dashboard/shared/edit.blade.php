...
<div class="row">
  <div class="col">
    <div class="card">
      <form method="POST" action="{{ $modifyAction }}"> <!-- route('district.update', $data[0]->district_id) -->
      @method('PATCH')
      @csrf
                      ...
                      <div class="{{$field['newModal_class']}}">
                        ...
                        @elseif ($field['db_type'].'' == 'select')
                          <?  $fieldName = explode(".",$field['name']);
                              if (sizeof($fieldName)>1) $fieldName = $fieldName[0]."_id";
                          ?>
          ...
          <div class="row">                         
            <div class="col-12">
              ...
              <div class="float-left col-2">
                <a href="{{ $deleteAction }}" class="btn btn-square btn-block btn-danger">{{ __('Delete') }}</a>
              </div>
            </div>
          </div>
        </div>
